...
public interface PiscinaRepository extends JpaRepository<Piscina, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO servicios (id, tipo, nombre) VALUES (:id, :tipo, :nombre); INSERT INTO piscinas (id, capacidad, area, profundidad) VALUES (:id, :capacidad, :area, :profundidad)", nativeQuery = true)
        void insertarPiscina(@Param("id") int id, @Param("tipo") int tipo, @Param("nombre") String nombre,
