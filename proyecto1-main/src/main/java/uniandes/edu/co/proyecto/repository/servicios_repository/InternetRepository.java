...
public interface InternetRepository extends JpaRepository<Internet, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO servicios (id, tipo, nombre) VALUES (:id, :tipo, :nombre); INSERT INTO internet (id, capacidad) VALUES (:id, :capacidad)", nativeQuery = true)
        void insertarServicioInternet(@Param("id") int id, @Param("tipo") int tipo, @Param("nombre") String nombre,
