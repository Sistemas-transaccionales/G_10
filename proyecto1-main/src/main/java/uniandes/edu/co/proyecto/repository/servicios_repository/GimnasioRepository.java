...
public interface GimnasioRepository extends JpaRepository<Gimnasio, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO servicios (id, tipo, nombre) VALUES (:id, :tipo, :nombre); INSERT INTO gimnasios (id, hora_apertura, hora_clausura, capacidad) VALUES (:id, :horaApertura, :horaClausura, :capacidad)", nativeQuery = true)
        void insertarGimnasio(@Param("id") int id, @Param("tipo") int tipo, @Param("nombre") String nombre,
