...
public interface TiendaRepository extends JpaRepository<Tienda, Integer> {
        ...
        @Modifying
        @Transactional
        @Query("INSERT INTO servicios (id, tipo, nombre) VALUES (:id, :tipo, :nombre); INSERT INTO tiendas (id, tipo_productos) VALUES (:id, :tipo_productos)")
        void insertarTienda(@Param("id") int id, @Param("tipo") int tipo, @Param("nombre") String nombre,
