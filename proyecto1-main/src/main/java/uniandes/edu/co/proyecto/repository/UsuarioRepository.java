...
public interface UsuarioRepository extends JpaRepository<Usuario, UsuarioPK> {
        ...
        void insertarUsuario(@Param("numDoc") Integer numDoc, @Param("tipoDoc") String tipoDoc,
                        @Param("tipoId") Integer tipoId, @Param("nombre") String nombre, @Param("email") String email,
        ...
        void actualizarUsuario(@Param("numDoc") Integer numDoc, @Param("tipoDoc") String tipoDoc,
                        @Param("tipoId") Integer tipoId, @Param("nombre") String nombre, @Param("email") String email,
                        @Param("password") String password);
