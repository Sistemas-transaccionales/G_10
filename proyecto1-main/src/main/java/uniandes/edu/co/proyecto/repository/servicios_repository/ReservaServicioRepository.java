...
public interface ReservaServicioRepository extends JpaRepository<ReservaServicio, ReservaServicioPK> {
        ...
        @Query(value = "SELECT * FROM reservas_servicios WHERE id_habitacion = :idHabitacion AND id_servicio = :idServicio AND fecha = :fecha AND hora_inicio = :horaInicio AND hora_fin = :horaFin AND costo = :costo", nativeQuery = true)
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO reservas_servicios (id_habitacion, id_servicio, fecha, hora_inicio, hora_fin, costo) VALUES (:idHabitacion, :idServicio, :fecha, :horaInicio, :horaFin, :costo)", nativeQuery = true)
        ...
        @Modifying
        @Transactional
        @Query(value = "UPDATE reservas_servicios SET fecha = :fecha, hora_inicio = :horaInicio, hora_fin = :horaFin, costo = :costo WHERE id_habitacion = :idHabitacion AND id_servicio = :idServicio AND fecha = :fecha, hora_inicio = :horaInicio, hora_fin = :horaFin", nativeQuery = true)
        ...
        @Modifying
        @Transactional
        @Query(value = "DELETE FROM reservas_servicios WHERE id_habitacion = :idHabitacion AND id_servicio = :idServicio AND fecha = :fecha AND hora_inicio = :horaInicio AND hora_fin = :horaFin AND costo = :costo", nativeQuery = true)
