...
public interface PrestamoUtensilioRepository extends JpaRepository<PrestamoUtensilio, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO servicios (id, tipo, nombre) VALUES (:id, :tipo, :nombre); INSERT INTO prestamos_utensilios (id, utensilio, costo_danio) VALUES (:id, :utensilio, :costo_danio)", nativeQuery = true)
        void insertarPrestamoUtensilio(@Param("id") int id, @Param("tipo") int tipo, @Param("nombre") String nombre,
