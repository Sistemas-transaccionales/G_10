...
public interface LavanderiaRepository extends JpaRepository<Lavanderia, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO servicios (id, tipo, nombre) VALUES (id_servicios.NEXTVAL, :tipo, :nombre); INSERT INTO lavanderias (id, tipo_prenda, num_prendas, costo) VALUES (id_servicios.CURRVAL, :tipoPrenda, :numPrendas, :costo)", nativeQuery = true)
