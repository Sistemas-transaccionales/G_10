...
public interface PlanConsumoRepository extends JpaRepository<PlanConsumo, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO planes_consumo (id, tipo_plan, tasa, min_noches, max_noches) VALUES (:id, :tipo_plan, :tasa, :min_noches, :max_noches)", nativeQuery = true)
        void insertarPlanConsumo(@Param("id") int id, @Param("tipo_plan") String tipo_plan, @Param("tasa") float tasa,
